...
Should the communal cupboard prove a distraction --- and it does, when you are dressing a character in her own things or assembling an outfit from them --- untick **Show shared**, which sits beneath the slot filters in the Wardrobe dialog beside its elder sibling **Show archived**. The borrowed rows withdraw, leaving only garments the character herself owns, and the list is once again a list of *her* clothes. The tickbox begins its life ticked, on the sound principle that a wardrobe should show you everything until you ask it not to; it is a matter of the view alone, and conceals nothing from the character, the tools, or the outfit she is already wearing. (Browsing a shared wardrobe rather than a character's, the box does not appear at all --- everything on display lives in the container you are looking at, and there is nothing borrowed to hide.)
