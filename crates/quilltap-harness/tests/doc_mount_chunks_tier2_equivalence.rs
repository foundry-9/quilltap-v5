...
//! Float32 buffer is exercised on insert (a non-empty `Vec<f32>` → the storage
//! blob via `embedding_blob::float32_to_blob`), as NULL (`None`/empty → SQL
...
//! buffer (`[0.5,-0.25,0.75,0.125]`, since v4 dd0d9ff5 int8-quantized to
