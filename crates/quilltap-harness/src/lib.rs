...
pub fn corpus() -> Vec<(&'static str, MemoryInputs)> {
    ...
    vec![
        ("fresh-high",          m(0.9, None,      "2026-06-27T00:00:00.000Z", None, None, None, 0)),
        ("old-high-floor",      m(0.9, None,      "2025-06-27T00:00:00.000Z", None, None, None, 0)),
        ("reinforced-recent",   m(0.5, Some(0.8), "2026-01-01T00:00:00.000Z", Some("2026-06-20T00:00:00.000Z"), None, None, 0)),
        ("retrieval-doesnt-reset", m(0.6, None,   "2026-03-01T00:00:00.000Z", None, Some("2026-06-26T00:00:00.000Z"), None, 0)),
        ("graph-heavy",         m(0.4, None,      "2026-05-01T00:00:00.000Z", None, None, None, 8)),
        ("reinforce-saturate",  m(0.5, None,      "2026-06-10T00:00:00.000Z", None, None, Some(64), 0)),
        ("recent-access-bonus", m(0.3, None,      "2026-04-01T00:00:00.000Z", None, Some("2026-06-01T00:00:00.000Z"), None, 0)),
        ("stale-access",        m(0.3, None,      "2026-01-01T00:00:00.000Z", None, Some("2026-01-15T00:00:00.000Z"), None, 0)),
        ("zero-importance",     m(0.0, None,      "2026-06-01T00:00:00.000Z", None, None, None, 0)),
        ("content-cap",         m(1.0, None,      "2026-06-27T06:00:00.000Z", None, None, None, 0)),
    ]
}
