...
const everyKindState: WorkspaceState = (() => {
  const kinds: TabKind[] = [
    'home', 'salon', 'terminal', 'document', 'aurora', 'prospero', 'scriptorium',
...
const routeHrefs = [
  ...
  '#anchor', // hash only
  '/prospero/xyz', // bare project detail → null (v5-only route, no v4 tab)
  '/scriptorium/xyz', // bare store detail → null
];
