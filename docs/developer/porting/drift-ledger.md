...
- **Oracle baseline: `d883a5ee1`** — "fix(memory): name the subject of a
  memory about someone else (bug 122)" (v4 main, 2026-09-05 00:48 -0500, v4
