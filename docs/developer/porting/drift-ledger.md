...
- **Oracle baseline:** `b121ac77f` — "feat(cli): rebuild a lost or
  ...
  (2026-08-27).
- **Checked:** 2026-08-31 (a full `/driftcheck`; the previous full checks
  were 2026-08-30, 2026-08-29 and 2026-08-27).
- **v4 `main` HEAD at check:** `60e3c4a0a` — **FIFTEEN commits past the
  baseline**. Four are new since the 2026-08-30 check.
