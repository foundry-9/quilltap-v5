...
- **A NEW ORDER IS NEEDED: v4's file logging is unported (finding #93, 2026-08-18).** v5 logs to
  ...
  convenience). **Why it matters beyond parity:** every warning v5 emits for a human to act on is
