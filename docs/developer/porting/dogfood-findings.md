...
- **The 2026-08-17 walk (the `d123658d` round) — IN PROGRESS, paused inside
  ...
  **Still unwalked in this round's own Part A:** A3 (the cleared-number draft
  on a real profile), A4 (profile tags end to end), A5 (the attachment-support
  line). Then Part B (the bug-70 context budget) and Part C (the standing 💸
  queue), both inherited unwalked from 2026-08-16.
