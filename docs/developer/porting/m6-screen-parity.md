...
| 14 | `p4.9l-salon-composer-toolbar` | the composer LAYOUT (v4's 2-column gutter grid + toolbar row + dominant editor) — v5's flattened one-row gutter squeezes the editor past its width floor and clips the placeholder (**dogfood #75**, functional not cosmetic); plus `roleplayTemplateId`-aware toolbar delimiters — a composer vertical, **not** a rider (`phase-4.md:1615-1618`) | lane | a composer toolbar must exist first |
