# Quilltap Changelog — June 2026

Archived from `docs/CHANGELOG.md`. Newest first; one entry per
commit, with the crate versions that commit bumped.

#### `69606bf6` — 2026-06-28 — Port turn-state machine (Phase 1, Wave 2/B5) with oracle test

_Versions: core 0.0.1, harness 0.0.1._
...
#### `d6986f08` — 2026-06-28 — Add the tier-2 DB-state oracle + folders fixture (Phase-2 on-ramp)
...
#### `647c3a06` — 2026-06-28 — Port the folders repo + cipher-correct DB layer — tier-2 round-trips green

_Versions: core 0.0.19, harness 0.0.19._
...
#### `57e251df` — 2026-06-30 — Port the chats slim-row marshaling (chats sub-unit 1)

_Versions: core 0.0.60, harness 0.0.59._
...
#### `37ed26d2` — 2026-06-30 — Port the chats slim-row read path (chats sub-unit 2)

_Versions: core 0.0.61, harness 0.0.60._
...
#### `1c7dd681` — 2026-06-30 — Port the chats messages read path (chats sub-unit 3)

_Versions: core 0.0.62, harness 0.0.61._
...
#### `177f818c` — 2026-06-30 — Port the chats messages write path (chats sub-unit 4a)

_Versions: core 0.0.63, harness 0.0.62._
...
#### `d717c288` — 2026-06-30 — Port the chats messages mutation path (chats sub-unit 4b)

_Versions: core 0.0.64, harness 0.0.63._
...
#### `354d94a5` — 2026-06-30 — Port the chats participant ops (chats sub-unit 5)

_Versions: core 0.0.65, harness 0.0.64._
...
#### `ac1b2ea3` — 2026-06-30 — Port the public wardrobe write path (closes seam #7)

_Versions: core 0.0.74, harness 0.0.68._
...
#### `da374f1b` — 2026-06-30 — Port write applier __finalizeFile + post-commit effects (closes seam #4)

_Versions: core 0.0.73, harness 0.0.67._
...
#### `1fb6c4f8` — 2026-06-30 — Read isSilentMessage faithfully (closes seam #8; the drop premise was wrong)

_Versions: core 0.0.71._
...
#### `15a29633` — 2026-06-30 — Port TagVisualStyle per-field defaults (closes seam #3)

_Versions: core 0.0.70._
...
#### `930709c9` — 2026-06-30 — Close the toLowerCase case-mapping seam (str::to_lowercase is faithful)

_Versions: core 0.0.69._
...
#### `aca1af5b` — 2026-06-30 — Add ICU collation for localeCompare (closes the collation seam)

_Versions: core 0.0.68._
...
#### `c1eb475a` — 2026-06-30 — Prove open-JSON multi-key insertion order (closes seam #5)

_Versions: core 0.0.72._
...
#### `1724d2af` — 2026-06-30 — Enable serde_json preserve_order workspace-wide (open-JSON key-order seam)

_Versions: core 0.0.67, harness 0.0.66._
...
#### `a79a16fd` — 2026-06-30 — Port the remaining four chats ops files (chats sub-unit 6)

_Versions: core 0.0.66, harness 0.0.65._
...
#### `5d9d46b9` — 2026-06-30 — Extract the SQLite3MC amalgamation into a pinned-version sys crate

_Versions: core 0.0.59, sqlite3mc-sys 0.1.0._
...
#### `0a7007e9` — 2026-06-30 — Port the memories repository (write/mutation + full read path)

_Versions: core 0.0.58, harness 0.0.58._
...
#### `bca422c2` — 2026-06-30 — Port the characters findBy* read path (characters sub-unit 4c)

_Versions: core 0.0.57, harness 0.0.57._
...
#### `c7764062` — 2026-06-30 — Port the character array / sub-array ops (characters sub-unit 4b)

_Versions: core 0.0.56, harness 0.0.56._
...
#### `cc33ea76` — 2026-06-30 — Port the update vault integration (characters sub-unit 4a)

_Versions: core 0.0.55, harness 0.0.55._
...
#### `9ca60ea9` — 2026-06-30 — Port ensureCharacterVault + the create integration (characters sub-unit 3b)

_Versions: core 0.0.54, harness 0.0.54._
...
#### `00fc6e70` — 2026-06-30 — Port scaffoldCharacterMount (characters sub-unit 3a)

_Versions: core 0.0.53, harness 0.0.53._
...
#### `9df067d1` — 2026-06-30 — Port the characters slim-row SQL marshaling (characters sub-unit 2)

_Versions: core 0.0.52, harness 0.0.52._
...
#### `b0d13d3c` — 2026-06-30 — Port the background_jobs repo (the durable work queue)

_Versions: core 0.0.51, harness 0.0.51._
...
#### `fb3ee600` — 2026-06-30 — Port the vector_indices repo (standalone two-table, BLOB embeddings)

_Versions: core 0.0.50, harness 0.0.50._
...
#### `e5e27c04` — 2026-06-28 — Port the tags repo (Phase-2 repo #2) with its tier-2 oracle test

_Versions: core 0.0.20, harness 0.0.20._

Phase 2 — repo-by-repo over the real DB (each ported repo arrives with its
tier-2 case):

#### `0d689484` — 2026-06-29 — Port three more Phase-2 repos in parallel (#8–#10) — first array-of-objects JSON column + Taggable lineage + the 29-column workhorse

_Versions: core 0.0.26, harness 0.0.26._
...
#### `66806014` — 2026-06-29 — Port five plain-base Phase-2 repos in parallel (#11–#15)

_Versions: core 0.0.27, harness 0.0.27._
...
#### `89055d45` — 2026-06-29 — Port five more Phase-2 repos in parallel (#16–#20)

_Versions: core 0.0.28, harness 0.0.28._
...
#### `d268ef03` — 2026-06-29 — Port the mount-index sibling-DB slice (5 repos) — first non-main-DB repos

_Versions: core 0.0.29, harness 0.0.29._
...
#### `94a2f365` — 2026-06-29 — Port the llm-logs sibling DB + the six deferred upsert* methods

_Versions: core 0.0.30, harness 0.0.30._
...
#### `f3aa2fcc` — 2026-06-29 — Port five more Phase-2 repos in parallel (#21–#25)

_Versions: core 0.0.31, harness 0.0.31._
...
#### `e63ceb0f` — 2026-06-29 — Port the document-store storage primitive (linkDocumentContent)

_Versions: core 0.0.32, harness 0.0.32._
...
#### `ae438a1a` — 2026-06-29 — Port the document-store overlay engine + the groups store-backed pilot

_Versions: core 0.0.33, harness 0.0.33._
...
#### `57e02fd6` — 2026-06-29 — Port the character vault managed-fields write projection (characters sub-unit 1)

_Versions: core 0.0.49, harness 0.0.49._
...
#### `92f2fec1` — 2026-06-29 — Port the wardrobe write projection (projectVaultWardrobe) — vault slice complete

_Versions: core 0.0.48, harness 0.0.48._
...
#### `3b9c4859` — 2026-06-29 — Port the wardrobe YAML emitter (buildWardrobeItemFile / Decision A)

_Versions: core 0.0.47, harness 0.0.47._
...
#### `06a582c9` — 2026-06-29 — Port the character vault wardrobe read overlay (readCharacterVaultWardrobe)

_Versions: core 0.0.46, harness 0.0.46._
...
#### `08cff76a` — 2026-06-29 — Port the character vault read overlay (hydrateOne + applyDocumentStoreOverlay)

_Versions: core 0.0.45, harness 0.0.45._
...
#### `540c6605` — 2026-06-29 — Port the vault read overlay's directory-listing load (findManyByMountPointsInFolder)

_Versions: core 0.0.44, harness 0.0.44._
...
#### `abfd7750` — 2026-06-29 — Port the vault Wardrobe/*.md parser (parseWardrobeItemFile)

_Versions: core 0.0.43, harness 0.0.43._
...
#### `39728917` — 2026-06-29 — Port the vault frontmatter READ parsers (parsePromptFile / parseScenarioFile)

_Versions: core 0.0.42, harness 0.0.42._
...
#### `e6bc496e` — 2026-06-29 — Port the markdown frontmatter parser + a hand-rolled YAML reader

_Versions: core 0.0.41, harness 0.0.41._
...
#### `877a8361` — 2026-06-29 — Port the legacy wardrobe.json migration parser (parseLegacyWardrobeJson)

_Versions: core 0.0.40, harness 0.0.40._
...
#### `5ac97e32` — 2026-06-29 — Port the vault JSON projection parsers

_Versions: core 0.0.39, harness 0.0.39._
...
#### `e1261435` — 2026-06-29 — Port the vault write-projection string leaves

_Versions: core 0.0.38, harness 0.0.38._
...
#### `57d43ac9` — 2026-06-29 — Port the vault wardrobe-component pure leaves

_Versions: core 0.0.37, harness 0.0.37._
...
#### `d1137fd9` — 2026-06-29 — Port doc_mount_blobs (the binary byte-store)

_Versions: core 0.0.36, harness 0.0.36._
...
#### `617995ae` — 2026-06-29 — Port stableUuidFromString (the first vault-overlay leaf)

_Versions: core 0.0.35, harness 0.0.35._
...
#### `cb49472e` — 2026-06-29 — Port the projects store-backed entity + generalize the store-backed base

_Versions: core 0.0.34, harness 0.0.34._
...
#### `cb54a1f8` — 2026-06-29 — docs: design slice for the document-store overlay
