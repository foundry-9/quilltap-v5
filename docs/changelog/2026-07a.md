# Quilltap Changelog — July 2026 (days 1–15)

Archived from `docs/CHANGELOG.md`. Newest first; one entry per
commit, with the crate versions that commit bumped.

#### `8c885993` — 2026-07-15 — P4.7b unit 4 (tier 2): the terminal stream transport seam + Tauri pipe

_Versions: SPA 0.5.126._
...
#### `35f4cd5e` — 2026-07-15 — P4.7b unit 3: the §3 origin resolver adopted across the raw REST surface

_Versions: SPA 0.5.125._
...
#### `ea214765` — 2026-07-15 — P4.7b unit 2: the Tauri CoreClient transport + bootstrap selection

_Versions: SPA 0.5.124._
...
#### `9fda2b8d` — 2026-07-15 — P4.7b unit 1: the CoreClient transport split (HttpCoreTransport extracted)

_Versions: SPA 0.5.123._
...
#### `ded86213` — 2026-07-15 — P4.7a lane close: gate record, tier dispositions, unifier notes
...
#### `2d232cbd` — 2026-07-15 — P4.7a unit 4: SS4 - the terminal stream over paired IPC (tier 2)

_Versions: tauri 0.0.2._
...
#### `e17e7032` — 2026-07-15 — P4.7a units 2-3: the quilltap-tauri shell crate + the IPC contract suite

_Versions: tauri 0.0.1._
...
#### `cf2708b4` — 2026-07-15 — P4.7a unit 1: extract the transport-agnostic cores from quilltap-web

_Versions: web 0.0.24._
...
#### `5b468b41` — 2026-07-15 — P4.7 round plan: the two Tauri work orders (shell ∥ SPA transport)
...
#### `ccc0443c` — 2026-07-15 — Unify the P4.6ar∥as∥at round: LLM Inspector + Default Aesthetics + minHeight — CLOSED
...
#### `4c3e8fc1` — 2026-07-15 — P4.6ar/as/at unification wires: fold the §1/§2 types, activate both beats

_Versions: harness 0.0.208, SPA 0.5.122._
...
#### `6a796f71` — 2026-07-15 — P4.6at unit 4: the Default Aesthetics e2e beat

_Versions: SPA 0.5.117._
...
#### `c74355bb` — 2026-07-15 — P4.6at unit 3: bind v4's minHeight at the sixteen residual sites

_Versions: SPA 0.5.116._
...
#### `06101495` — 2026-07-15 — P4.6at unit 2: the Default Aesthetics card

_Versions: SPA 0.5.115._
...
#### `8cd1cff9` — 2026-07-15 — P4.6at unit 1: extract the shared aesthetic-editor-field

_Versions: SPA 0.5.114._
...
#### `9db99dd0` — 2026-07-15 — P4.6as unit 5: a discovery guard that races decides coverage by luck

_Versions: SPA 0.5.118._
...
#### `2fe915c7` — 2026-07-15 — P4.6as unit 4: the closed slide-over must not claim to be a dialog
...
#### `fc4b5d22` — 2026-07-15 — P4.6as unit 3: the LLM-Inspector e2e beat + the llm-logs seed
...
#### `8661f650` — 2026-07-15 — P4.6as unit 2: the LLM-Inspector host wiring
...
#### `e302bbd9` — 2026-07-15 — P4.6as unit 1: the LLM-Inspector components
...
#### `845a9976` — 2026-07-15 — P4.6ar unit 4: prove the llm-logs wire key order; correct a stale seam note

_Versions: core 0.0.228, harness 0.0.207._
...
#### `05d5426c` — 2026-07-15 — P4.6ar unit 3: the system image-aesthetics pair + its differential

_Versions: core 0.0.227, harness 0.0.206._
...
#### `7dfffc3a` — 2026-07-15 — P4.6ar units 1-2: the llm-logs read surface + its differential

_Versions: core 0.0.226, harness 0.0.205, web 0.0.23._
...
#### `4e017dc6` — 2026-07-15 — P4.6ar unit 0: the inspector-* fixture family + its generator
...
#### `b74b276d` — 2026-07-15 — Plan the P4.6ar∥as∥at round: LLM Inspector + Default Aesthetics + minHeight residual
...
#### `8e0ed0b5` — 2026-07-15 — Unify the P4.6ao∥ap∥aq round: token/cost + background generation + form fields — CLOSED
...
#### `decdaa2c` — 2026-07-15 — P4.6ao/ap/aq unification: image_profiles joins the e2e userId rewrite
...
#### `c30f0506` — 2026-07-15 — P4.6ao/ap/aq unification wires: fold the §1/§2 request types, activate the two beats
...
#### `eae4fe33` — 2026-07-15 — P4.6aq unit 5: the e2e walks follow the swapped fields

_Versions: SPA 0.5.113._
...
#### `16094cde` — 2026-07-15 — P4.6aq unit 4: the appearance / image-prompt fields (sites 9-10)

_Versions: SPA 0.5.112._
...
#### `45f87a7e` — 2026-07-15 — P4.6aq unit 3: the qt-markdown-field swaps at sites 5-8

_Versions: SPA 0.5.111._
...
#### `d7736778` — 2026-07-15 — P4.6aq unit 2: the qt-markdown-field swaps at sites 1-4

_Versions: SPA 0.5.110._
...
#### `34ca9615` — 2026-07-15 — P4.6ap unit 7: fix the token-badge beat's in-suite failure

_Versions: SPA 0.5.108._
...
#### `47557ba6` — 2026-07-15 — P4.6ap unit 6 (tier 2): four live e2e beats

_Versions: SPA 0.5.107._
...
#### `10d3baa6` — 2026-07-15 — P4.6ap unit 5: the Regenerate Background entry + both polls

_Versions: SPA 0.5.106._
...
#### `ebf006df` — 2026-07-15 — P4.6ap unit 4: the Story Backgrounds settings card

_Versions: SPA 0.5.105._
...
#### `1a0b7e14` — 2026-07-15 — P4.6ap unit 3: the chat-totals header summary

_Versions: SPA 0.5.104._
...
#### `64f26111` — 2026-07-15 — P4.6ap unit 2: the per-message token badge

_Versions: SPA 0.5.103._
...
#### `35298029` — 2026-07-15 — P4.6ao unit 3: the TITLE_UPDATE job handler

_Versions: core 0.0.225, harness 0.0.204, host 0.0.18._
...
#### `ed84c33b` — 2026-07-15 — P4.6ao unit 2: the regenerate-background un-refusal

_Versions: core 0.0.224, harness 0.0.203._
...
#### `3dd8f7cd` — 2026-07-15 — P4.6ao unit 1: the chatGetCost verb + the raw REST leg

_Versions: core 0.0.223, harness 0.0.202, web 0.0.22._
...
#### `acab1abc` — 2026-07-15 — Plan the P4.6ao∥ap∥aq round: token/cost + background generation + form fields
...
#### `5d022e32` — 2026-07-15 — Unify the P4.6an round: Chat-tab cards + cron preview — CLOSED
...
#### `b02ad204` — 2026-07-15 — P4.6an unit 9: live e2e beats for the Chat-tab cards + cron preview

_Versions: SPA 0.5.101._
...
#### `1f361f1c` — 2026-07-15 — P4.6an unit 8: the composer spellcheck rider (tier 2)

_Versions: SPA 0.5.100._
...
#### `5cd6d1cb` — 2026-07-15 — P4.6an unit 7: the Chat tab in v4's full 16-card order

_Versions: SPA 0.5.99._
...
#### `c32a696a` — 2026-07-15 — P4.6an unit 6: Image Description + Dangerous Content cards

_Versions: SPA 0.5.98._
...
#### `1686fddf` — 2026-07-15 — P4.6an unit 5: Agent Mode + Context Compression cards

_Versions: SPA 0.5.97._
...
#### `20a1f508` — 2026-07-15 — P4.6an unit 4: Token Display, Memory Cascade, Thinking/Reasoning cards

_Versions: SPA 0.5.96._
...
#### `1490cdde` — 2026-07-15 — P4.6an unit 3: the four scalar-toggle Chat-tab cards

_Versions: SPA 0.5.95._
...
#### `b5a7aa9b` — 2026-07-15 — P4.6an unit 2: live cron next-run preview (croner)

_Versions: SPA 0.5.94._
...
#### `7918cd5b` — 2026-07-15 — P4.6an unit 1: Zod-faithful dangerousContentSettings parse

_Versions: core 0.0.222, harness 0.0.201._
...
#### `f5495072` — 2026-07-14 — Plan the P4.6an round: the Chat-tab cards remainder + cron preview
...
#### `afd57bce` — 2026-07-14 — Dogfood pass 2026-07-15: record covered-vs-deferred in the standing notes
...
#### `c6b58b1f` — 2026-07-14 — Dogfood findings #10/#11: v4-faithful, recorded NOT-A-BUG
...
#### `35822039` — 2026-07-14 — Dogfood log: mark findings #7/#8/#9 FIXED and the #6 select audit CLOSED (P4.6ak∥al∥am)
...
#### `7c76aee9` — 2026-07-14 — Unify P4.6ak∥al∥am: round record, order headers, phase plan, CLAUDE.md status
...
#### `99fdadd5` — 2026-07-14 — P4.6am tier 2: story-background e2e beat (dogfood #9)

_Versions: SPA 0.5.93._
...
#### `b53d550f` — 2026-07-14 — P4.6am/3: last select-audit site (dogfood #6, closes the audit)

_Versions: SPA 0.5.92._
...
#### `0ca391a0` — 2026-07-14 — P4.6am/2: chat background images (dogfood #9)

_Versions: SPA 0.5.91._
...
#### `e1d2450e` — 2026-07-14 — P4.6am/1: chained-response streaming render (dogfood #7)

_Versions: SPA 0.5.90._
...
#### `31e3ca7a` — 2026-07-14 — P4.6al: fix new-character spec after the Identity markdown-field adoption

_Versions: SPA 0.5.89._
...
#### `d626a7a8` — 2026-07-14 — P4.6al item 5: text-replacement plugin + settings card

_Versions: SPA 0.5.88._
...
#### `eb2a99d9` — 2026-07-14 — P4.6al item 4: composer draft persistence

_Versions: SPA 0.5.87._
...
#### `ac8c3015` — 2026-07-14 — P4.6al item 3: shared qt-markdown-field + FormattingToolbar

_Versions: SPA 0.5.86._
...
#### `462f8a10` — 2026-07-14 — P4.6al item 2: composition mode composer-side (dogfood #8)

_Versions: SPA 0.5.85._
...
#### `5e606623` — 2026-07-14 — P4.6al item 1: strikethrough/highlight marks + emphasis-on-type rules

_Versions: SPA 0.5.84._
...
#### `a85a7985` — 2026-07-14 — Refuse the chat regenerate-background action loudly (P4.6ak lane A, tier 2)

_Versions: core 0.0.221._
...
#### `24b85f71` — 2026-07-14 — Port the text-replacements + get-background server surface (P4.6ak lane A)

_Versions: core 0.0.220, harness 0.0.200, web 0.0.21._
...
#### `5cc82f23` — 2026-07-14 — Plan the D17 editor follow-ons + salon dogfood round (P4.6ak∥al∥am)
...
#### `e77d8c07` — 2026-07-14 — Dogfood findings #7-#9: chained-response rendering gap, composition mode, chat backgrounds
...
#### `2db968c6` — 2026-07-14 — Unify P4.6ah∥ai∥aj∥d4: round record, order headers, baseline 02865bdb, phase plan
...
#### `c5883c3e` — 2026-07-14 — Unify gate fix P4.6ah∥aj: unwrap Files/ChatMedia at the REST edge; e2e folders table + general-chat attach beat
...
#### `001526db` — 2026-07-14 — Unify wire P4.6ah∥ai∥aj∥d4: version accumulation, journal cruft drop, composer-attach live beat

_Versions: core 0.0.219, harness 0.0.199._
...
#### `eca6d2ab` — 2026-07-14 — P4.6ah: files write + maintenance server remainder (differential GREEN)

_Versions: core 0.0.217, harness 0.0.197, web 0.0.20._
...
#### `29ff9f6e` — 2026-07-14 — P4.6ai: un-refuse imageProfileGenerate over a new host image-generation seam

_Versions: host 0.0.17._
...
#### `a6df8e37` — 2026-07-14 — P4.d4: re-port the 02865bdb skip-signal trailing-sentinel strip
...
#### `9505fd67` — 2026-07-14 — P4.6aj: the files SPA delete-associations close-out (lane C)

_Versions: SPA 0.5.83._
...
#### `d7acc182` — 2026-07-14 — Plan the "finish P4.6ae + catch up from v4" round (P4.6ah∥ai∥aj∥P4.d4)
...
#### `c1215376` — 2026-07-14 — Unify P4.6ae∥af∥ag: round record, order headers, D17 note, oracle-baseline versions
...
#### `2878641a` — 2026-07-14 — Unify wire P4.6ae∥af∥ag: files data-beat guard covers the OPEN upload REST leg

_Versions: SPA 0.5.82._
...
#### `14cc557c` — 2026-07-14 — P4.6ag tier 2 (unit 6): live e2e beats for the rich editor

_Versions: SPA 0.5.81._
...
#### `dac58c5f` — 2026-07-14 — P4.6ag tier 2 (unit 5): markdown input rules + formatting commands

_Versions: SPA 0.5.80._
...
#### `bf26cfc9` — 2026-07-14 — P4.6ag tier 1 (unit 4): the Salon composer adopts qt-rich-editor

_Versions: SPA 0.5.79._
...
#### `38066ed8` — 2026-07-14 — P4.6ag tier 1 (unit 3): Document Mode adopts qt-rich-editor for markdown

_Versions: SPA 0.5.78._
...
#### `5ab2204c` — 2026-07-14 — P4.6ag tier 1 (unit 2): the qt-rich-editor ProseMirror component

_Versions: SPA 0.5.77._
...
#### `b6f053d3` — 2026-07-14 — P4.6ag tier 0: the D17 ProseMirror round-trip gate (GREEN)

_Versions: SPA 0.5.76._
...
#### `be5f58e1` — 2026-07-14 — P4.6af unit 7: the e2e walks (v4 dd0d9ff5)

_Versions: SPA 0.5.75._
...
#### `36056996` — 2026-07-14 — P4.6af unit 5: the salon autonomous riders (v4 dd0d9ff5)

_Versions: SPA 0.5.74._
...
#### `60be09a2` — 2026-07-14 — P4.6af units 2-4,6: the general Files page (v4 dd0d9ff5)

_Versions: SPA 0.5.73._
...
#### `ed804873` — 2026-07-14 — P4.6af unit 1: the general files-family wire contract (v4 dd0d9ff5)

_Versions: SPA 0.5.72._
...
#### `60e239a8` — 2026-07-14 — P4.6ae units 2+3+5: general files dispatch surface + differential

_Versions: core 0.0.216, harness 0.0.196._
...
#### `18028d80` — 2026-07-14 — P4.6ae unit 1: files-family db-layer + folder-path leaves

_Versions: core 0.0.215._
...
#### `c1ed1ccc` — 2026-07-14 — Unify P4.d3: round record, order header CLOSED, oracle baseline rebased to dd0d9ff5
...
#### `4374e881` — 2026-07-14 — P4.d3 unit 6: the SPA Data Retention card (v4 dd0d9ff5)

_Versions: SPA 0.5.71._
...
#### `6ff549c1` — 2026-07-13 — P4.d3 unit 5: dataRetention setting + dispatch surface (v4 dd0d9ff5)

_Versions: core 0.0.214, harness 0.0.195._
...
#### `1c7ffdb3` — 2026-07-13 — P4.d3 unit 4: cold-chunk re-embed on open (v4 dd0d9ff5)

_Versions: core 0.0.213, harness 0.0.194._
...
#### `36b13e99` — 2026-07-13 — P4.d3 unit 3: stale-chat cache collapse + cold-tiering (v4 dd0d9ff5)

_Versions: core 0.0.212, harness 0.0.193._
...
#### `6cd86934` — 2026-07-13 — P4.d3 unit 2: re-baseline the embedding differential batch to dd0d9ff5

_Versions: harness 0.0.192._
...
#### `c333d28d` — 2026-07-13 — P4.d3 unit 1: header-aware quantized embedding blob codec (v4 dd0d9ff5)

_Versions: core 0.0.211._
...
#### `47d4d380` — 2026-07-13 — Drift-amend the round to four lanes: P4.d3 re-ports v4 dd0d9ff5 (DB size reduction)
...
#### `79cfdd79` — 2026-07-13 — Plan the files-family + editor round: P4.6ae/P4.6af/P4.6ag work orders
...
#### `df6e7bd3` — 2026-07-13 — Close the P4.6ab/P4.6ac/P4.6ad + terminal-probe round: unified, full gate green

_Versions: SPA 0.5.70._
...
#### `1463abee` — 2026-07-13 — P4.6ad SPA half: the autonomous-rooms vertical goes live
...
#### `deae4b6d` — 2026-07-13 — P4.6ad server half: the autonomous-rooms dispatch surface
...
#### `e3e1fd20` — 2026-07-13 — P4.6ac lane B units 6+7: composer attach + courier/images e2e walk (Tier 2.8+2.9)

_Versions: SPA 0.5.65._
...
#### `03e14b7e` — 2026-07-13 — P4.6ac lane B units 4+5: SaveImageDialog + PhotoGalleryModal (Tier 2.5+2.6)

_Versions: SPA 0.5.64._
...
#### `8162bb70` — 2026-07-13 — P4.6ac lane B units 2+3: Courier bubble + in-chat image lightbox (Tier 1.1+1.2)

_Versions: SPA 0.5.63._
...
#### `0e3bc61e` — 2026-07-13 — P4.6ac lane B unit 1: markdown store-image rewrite (Tier 1.3)
...
#### `f12b7646` — 2026-07-13 — Plan the P4.6ab/P4.6ac/P4.6ad round: courier+images + autonomous-rooms orders
...
#### `9ab41699` — 2026-07-13 — Wire the terminal liveness probe: chat_get reconciles over the real PTY map

_Versions: core 0.0.208, harness 0.0.189, host 0.0.16._
...
#### `4c7a3181` — 2026-07-13 — Fix the terminal-flow in-suite failure: count-baseline chip gesture

_Versions: SPA 0.5.62._
...
#### `78d8541a` — 2026-07-13 — Drift re-port: the nudge Host announcement (v4 6a8a77aa) — baseline REBASED

_Versions: core 0.0.207, harness 0.0.188, SPA 0.5.61._
...
#### `b64506bc` — 2026-07-13 — Close the P4.6z/P4.6aa round: unified, full gate green, D18 DECIDED
...
#### `cedcd820` — 2026-07-13 — P4.6z/P4.6aa gate fixes: e2e ordering + gesture — file-manager walk ACTIVE

_Versions: SPA 0.5.60._
...
#### `742d0229` — 2026-07-13 — P4.6z/P4.6aa unification wire: the file-manager toggle + MountCapabilities dedupe

_Versions: SPA 0.5.59._
...
#### `ec0f94a0` — 2026-07-13 — P4.6z unit 3: the live Scriptorium e2e walk (lane A)

_Versions: SPA 0.5.52._
...
#### `8510a02d` — 2026-07-13 — P4.6z unit 2: the Scriptorium SPA vertical (lane A)

_Versions: SPA 0.5.51._
...
#### `81887e67` — 2026-07-13 — P4.6aa lane B: gate — e2e afterAll cleanup + gate record

_Versions: SPA 0.5.58._
...
#### `fa5ddd3a` — 2026-07-13 — P4.6aa lane B unit 5: the <select [value]> audit rider (dogfood-#6)

_Versions: SPA 0.5.57._
...
#### `ed6261e2` — 2026-07-13 — P4.6aa lane B unit 4: the probe-guarded e2e walk

_Versions: SPA 0.5.56._
...
#### `0c8d26cf` — 2026-07-13 — P4.6aa lane B unit 3: the qt-file-manager component (bespoke, D18)

_Versions: SPA 0.5.55._
...
#### `9515d42c` — 2026-07-13 — P4.6aa lane B unit 2: the file-manager wiring core

_Versions: SPA 0.5.54._
...
#### `5d9f40f2` — 2026-07-13 — P4.6aa lane B unit 1: D18 spike verdict + the adapter helpers

_Versions: SPA 0.5.53._
...
#### `2722d3ae` — 2026-07-13 — P4.6z/P4.6aa round setup: the Scriptorium SPA (D18) work orders
...
#### `ad7000cc` — 2026-07-13 — Close the P4.6y round: unified, full gate green, P4.6v/D7 CLOSED, refresh seam LIVE
...
#### `941f59b9` — 2026-07-13 — P4.6y unit K: close D7, mark P4.6v CLOSED, close-out records + full lane gate
...
#### `c4639bca` — 2026-07-13 — P4.6y unit J: wire EngineAssembly.mount_refresh live + refresh-parity differential

_Versions: core 0.0.205, harness 0.0.187, host 0.0.15._
...
#### `9c54735c` — 2026-07-13 — P4.6y unit H: web-edge fs raw read + multipart PUT/write-file/blob-upload legs

_Versions: core 0.0.204, web 0.0.17._
...
#### `1741fb53` — 2026-07-13 — P4.6y unit I: convert/deconvert refusal arms (guards live, conversion loudly refused)

_Versions: core 0.0.203, harness 0.0.186._
...
#### `55538706` — 2026-07-13 — P4.6y units B+G: storeMountFile ingest + blob routes (mount-write differential 22/22)

_Versions: core 0.0.202, harness 0.0.185._
...
#### `99bfab1b` — 2026-07-12 — P4.6y units C+D: file/folder mutation surface + PATCH + folder-create (mount-ops differential 39/39)

_Versions: core 0.0.201, harness 0.0.184._
...
#### `46031618` — 2026-07-12 — P4.6y unit E: reindex + scoped embed + semantic search variants (differential 14/14)

_Versions: core 0.0.200, harness 0.0.183._
...
#### `ad605f70` — 2026-07-12 — P4.6y unit F: scanner + converters + embedding scheduler + mountScan (differential-proven)

_Versions: core 0.0.199, harness 0.0.182._
...
#### `2ec36758` — 2026-07-12 — P4.6y unit A: mounts fixture extension (TF-IDF profile + extraction substrate + pinned chunks)

_Versions: web 0.0.16._
...
#### `8400a392` — 2026-07-12 — P4.6y work order: the P4.6v remainder as a single resumption lane
...
#### `ab6141c2` — 2026-07-12 — Close the P4.6v/w/x round: gate green 29/29, P4.6w/x CLOSED, P4.6v remainder enumerated
...
#### `96a66d9e` — 2026-07-12 — Fix the P4.6x document beats at first live run: focusout + spec ordering + shared-chat residue

_Versions: SPA 0.5.50._
...
#### `158915f2` — 2026-07-12 — P4.6vwx unification wires: record the mount_refresh seam as still-unwired

_Versions: host 0.0.14._
...
#### `fa0e67de` — 2026-07-12 — Port the P4.6v mount READ + LIST surface with its fixture family

_Versions: core 0.0.195, harness 0.0.179._
...
#### `c90f6613` — 2026-07-12 — Port the P4.6v mount-index pure leaves: chunker + path-utils + file-op-status

_Versions: core 0.0.194, harness 0.0.178, web 0.0.14._
...
#### `0faa20a1` — 2026-07-12 — P4.6w unit 3: the Document Mode route surface (api::documents)

_Versions: core 0.0.198, harness 0.0.181, host 0.0.13._
...
#### `f34f2046` — 2026-07-12 — P4.6w unit 2: the documents operator-doc-actions core

_Versions: core 0.0.197, harness 0.0.180._
...
#### `56a7931e` — 2026-07-12 — P4.6w unit 1: extend the chat_documents repo for Document Mode

_Versions: core 0.0.196._
...
#### `a1a490ce` — 2026-07-12 — Write the P4.6v/w/x work orders: the Document Mode + Scriptorium-server round
...
#### `f8042890` — 2026-07-12 — Close the P4.6s/t/u round: full gate green, orders CLOSED, docs sealed
...
#### `5e3a6483` — 2026-07-12 — P4.6u lane C unit 5: the LIVE terminal-flow e2e + the fixes it forced

_Versions: SPA 0.5.39._
...
#### `dafc97e9` — 2026-07-12 — P4.6u lane C unit 4: inline terminal embed + pop-out route
...
#### `45b44798` — 2026-07-12 — P4.6u lane C unit 3: terminal pane + picker + Salon wiring
...
#### `5c3d23b3` — 2026-07-12 — P4.6u lane C unit 2: terminal REST api + mode controller + split layout
...
#### `2ba79354` — 2026-07-12 — Author the fixture-guarded Memory e2e beats (P4.6t unit 4)

_Versions: SPA 0.5.38._
...
#### `a2845246` — 2026-07-12 — Populate the Settings Memory tab: the Commonplace Book cards (P4.6t unit 3)

_Versions: SPA 0.5.37._
...
#### `60f87e98` — 2026-07-12 — Add the per-character memory Cleanup (housekeeping) dialog (P4.6t unit 2)

_Versions: SPA 0.5.36._
...
#### `aca0ae85` — 2026-07-12 — Close the memories-tab placeholder: the character Commonplace Book vertical (P4.6t unit 1)

_Versions: SPA 0.5.35._
...
#### `0c8d740a` — 2026-07-12 — P4.6s memories server, part 4: regenerate + backfill status (tier 1 complete)

_Versions: core 0.0.192, harness 0.0.176._
...
#### `dc0c4365` — 2026-07-12 — P4.6s memories server, part 3: housekeeping + config arms

_Versions: core 0.0.191, harness 0.0.175._
...
#### `6b2ab239` — 2026-07-12 — P4.6s memories server, part 2: the write + search arms

_Versions: core 0.0.190, harness 0.0.174._
...
#### `34998825` — 2026-07-12 — P4.6s memories server, part 1: the fixture + the read arms

_Versions: core 0.0.189, harness 0.0.173._
...
#### `9b22937b` — 2026-07-12 — Write the P4.6s/t/u work orders: the Commonplace Book + terminal-pane round
...
#### `853ba909` — 2026-07-12 — Close the P4.6p/q/r round: full gate green, orders CLOSED, docs sealed

_Versions: SPA 0.5.34._
...
#### `8f35fa77` — 2026-07-12 — Wire the P4.6p/q/r seams: one contract appendix, union-fold dispatch, null echoes

_Versions: SPA 0.5.33._
...
#### `bf121997` — 2026-07-12 — Wire the reset-builtins rider + the P4.6r e2e beats (P4.6r lane C, part 3)

_Versions: SPA 0.5.32._
...
#### `7c8f8366` — 2026-07-12 — Enable the three default-* pickers over the P4.6p listings (P4.6r lane C, part 2)

_Versions: SPA 0.5.31._
...
#### `67918f7c` — 2026-07-12 — Populate the Templates & Images settings tabs (P4.6r lane C, part 1)

_Versions: SPA 0.5.30._
...
#### `a358778f` — 2026-07-12 — Add the Salon-list New-Chat rider + the e2e beat (P4.6q u7)

_Versions: SPA 0.5.29._
...
#### `085ea200` — 2026-07-12 — Port the /salon/new route + page (P4.6q u6)

_Versions: SPA 0.5.28._
...
#### `fa1e226b` — 2026-07-12 — Port the New-Chat form body + shared children (P4.6q u5)

_Versions: SPA 0.5.27._
...
#### `640227a8` — 2026-07-12 — Port the Green Room creation-progress dialog (P4.6q u4)

_Versions: SPA 0.5.26._
...
#### `2e1a421a` — 2026-07-12 — Port the New-Chat character picker panel (P4.6q u3)

_Versions: SPA 0.5.25._
...
#### `aebdf586` — 2026-07-12 — Port the new-chat state service + pure logic (P4.6q u2)

_Versions: SPA 0.5.24._
...
#### `bfcf52b1` — 2026-07-12 — Re-pin the New-Chat contract seams + the listing-surface appendix (P4.6q u1)

_Versions: SPA 0.5.23._
...
#### `4ffb99fc` — 2026-07-12 — Port the global mount-points dispatch surface (P4.6p unit 4)

_Versions: core 0.0.188, harness 0.0.172._
...
#### `006bbb32` — 2026-07-12 — Port the image-profiles dispatch surface (P4.6p unit 3)

_Versions: core 0.0.187, harness 0.0.171._
...
#### `cd6c6a54` — 2026-07-12 — Port the roleplay-templates dispatch surface (P4.6p unit 2)

_Versions: core 0.0.186, harness 0.0.170, web 0.0.13._
...
#### `e40be381` — 2026-07-12 — Extend the groups-projects fixture with the listing-surface rows (P4.6p)
...
#### `b37a1a7d` — 2026-07-12 — Port generateRenderingPatterns as the pure services::annotations module (P4.6p unit 1)

_Versions: core 0.0.185, harness 0.0.169._
...
#### `e6e22036` — 2026-07-12 — Write the P4.6p/q/r round orders: listing surfaces + New-Chat + settings tabs
...
#### `4901950b` — 2026-07-12 — Close the P4.6n/o/4u4 round: full gate green, orders CLOSED, docs sealed

_Versions: web 0.0.12, SPA 0.5.22._
...
#### `3c94c46b` — 2026-07-11 — Wire the P4.6n/o/4u4 seams: reset-builtins at the web edge, seed default-ON

_Versions: host 0.0.12, web 0.0.11._
...
#### `8888d730` — 2026-07-11 — Re-pin the SPA scenario contract + add the general family (P4.6o)

_Versions: SPA 0.5.17._
...
#### `ef86703e` — 2026-07-11 — Build the scope-agnostic scenarios manager family (P4.6o)

_Versions: SPA 0.5.18._
...
#### `a17fad9c` — 2026-07-11 — Build the project wardrobe manager (P4.6o)

_Versions: SPA 0.5.19._
...
#### `71d5dbda` — 2026-07-11 — Wire the Scenarios + Wardrobe cards + the general scenarios page (P4.6o)

_Versions: SPA 0.5.20._
...
#### `51150cd9` — 2026-07-11 — Author the P4.6o Playwright beats + the lane status-log record

_Versions: SPA 0.5.21._
...
#### `7a8434b6` — 2026-07-11 — P4.4u4 unit 3: reset_builtins as a service (tier 2)

_Versions: core 0.0.184, harness 0.0.168._
...
#### `423637bf` — 2026-07-11 — P4.4u4 unit 2: the startup sample-content seed wire + avatar seeding

_Versions: core 0.0.183, harness 0.0.167, host 0.0.11._
...
#### `62b4c048` — 2026-07-11 — P4.4u4 unit 1: the quilltap-import seed subset (service + differential + assets)

_Versions: core 0.0.182, harness 0.0.166._
...
#### `a0577dc6` — 2026-07-11 — Make project list-files + add/remove live (P4.6n unit 5)

_Versions: core 0.0.181, harness 0.0.165._
...
#### `8e41c5f6` — 2026-07-11 — Add the general (instance-wide) scenarios family (P4.6n unit 4)

_Versions: core 0.0.180, harness 0.0.164._
...
#### `64e77002` — 2026-07-11 — Make the projects scenarios surface live (P4.6n unit 3)

_Versions: core 0.0.179, harness 0.0.163._
...
#### `aa5ce877` — 2026-07-11 — Make the groups scenarios surface live (P4.6n unit 2)

_Versions: core 0.0.178, harness 0.0.162._
...
#### `a261f905` — 2026-07-11 — Extend the groups-projects fixture for the scenarios surface (P4.6n)
...
#### `c3797d7d` — 2026-07-11 — Port the scenarios-common service surface (P4.6n unit 1)

_Versions: core 0.0.177._
...
#### `4aeb30e3` — 2026-07-11 — Plan the P4.6n/P4.6o/P4.4u4 round: three work orders + the scenario re-pin
...
#### `aeb3b2fb` — 2026-07-11 — Record the P4.6k/l/m round: status-log record, order headers, phase plan, CLAUDE.md
...
#### `63deabd8` — 2026-07-11 — Wire the P4.6k/l/m live seams: nested update bags, the dialog z-trap, live rider beats

_Versions: SPA 0.5.16._
...
#### `3f7242a3` — 2026-07-11 — Port project wardrobe CRUD (P4.6k lane A unit 4)

_Versions: core 0.0.176, harness 0.0.161._
...
#### `c452cea1` — 2026-07-11 — Port project background + aesthetic editor (P4.6k lane A unit 5, partial)

_Versions: core 0.0.175, harness 0.0.160._
...
#### `86714523` — 2026-07-11 — Port the Projects server surface to the core boundary (P4.6k lane A unit 2)

_Versions: core 0.0.174, harness 0.0.159._
...
#### `1cce23b6` — 2026-07-11 — Port the Groups server surface to the core boundary (P4.6k lane A unit 1)

_Versions: core 0.0.173, harness 0.0.158._
...
#### `10ad85c0` — 2026-07-11 — Add the ST import multipart route + main-avatar vault write (P4.6m unit 4)

_Versions: web 0.0.10._
...
#### `4c5e11c3` — 2026-07-11 — Add the SillyTavern PNG export route (P4.6m unit 3)

_Versions: web 0.0.9._
...
#### `23abb096` — 2026-07-11 — Add quilltap-web multipart + the photos POST route (P4.6m unit 2)

_Versions: web 0.0.8._
...
#### `5bee24a6` — 2026-07-11 — Port the SillyTavern PNG codec (P4.6m unit 1, tier-1)
...
#### `781e73eb` — 2026-07-11 — Project-detail tier-2 cards: Files + Image Generation (P4.6l lane B)

_Versions: SPA 0.5.15._
...
#### `ad5ce9a6` — 2026-07-11 — Characters riders (gallery upload + PNG export) + the select audit (P4.6l lane B)

_Versions: SPA 0.5.14._
...
#### `fc07efcc` — 2026-07-11 — Build the Projects (Prospero) SPA vertical tier-1 (P4.6l lane B)

_Versions: SPA 0.5.13._
...
#### `bcb93e95` — 2026-07-11 — Build the Groups SPA vertical (Characters-page section + routed editor) (P4.6l lane B)

_Versions: SPA 0.5.12._
...
#### `eabeec17` — 2026-07-11 — Write the P4.6k/l/m round work orders (groups+projects ∥ SPA ∥ multipart)
...
#### `18f25485` — 2026-07-11 — Record the P4.6i/j characters-remainder round unification (docs)
...
#### `ae3f452c` — 2026-07-11 — Scope the characters-remainder round (P4.6i ∥ P4.6j)
...
#### `6d22b048` — 2026-07-12 — P4.6x unit 1: the Document Mode state store + the core-contract document block

_Versions: SPA 0.5.44._
...
#### `07a6488f` — 2026-07-12 — P4.6x unit 7: the Document Mode e2e beats (fixture-guarded)

_Versions: SPA 0.5.49._
...
#### `af8abcd8` — 2026-07-12 — P4.6x unit 5: tool-result reload wiring

_Versions: SPA 0.5.48._
...
#### `34d63bb4` — 2026-07-12 — P4.6x unit 3: Document Mode split integration

_Versions: SPA 0.5.47._
...
#### `52613df2` — 2026-07-12 — P4.6x unit 4: the qt-document-picker modal

_Versions: SPA 0.5.46._
...
#### `1755e400` — 2026-07-12 — P4.6x unit 2: the qt-document-pane component

_Versions: SPA 0.5.45._
...
#### `7b0238fd` — 2026-07-12 — P4.6x: the D17 Lexical spike is RED — Document Mode markdown ships in the textarea
...
#### `1cfbc8f1` — 2026-07-11 — Add the missing changelog entry for the finding #6 root-cause fix
...
#### `ba216ec4` — 2026-07-11 — Surface failed Default Settings saves in the tab alert (dogfood finding #6, error-visibility half)

_Versions: SPA 0.5.10._
...
#### `7c5c93b9` — 2026-07-11 — Fix the System Prompts tab whitespace leak via a shared TemplateDisplay (dogfood finding #5)

_Versions: SPA 0.5.9._
...
#### `593db549` — 2026-07-11 — Reconcile the gallery contract and activate the P4.6j live e2e beats (P4.6i/j unification wire)

_Versions: SPA 0.5.8._
...
#### `66438561` — 2026-07-11 — Verify ST import + add the Export (JSON) action and live e2e beats (P4.6j unit 4)

_Versions: SPA 0.5.7._
...
#### `64b45337` — 2026-07-11 — Verify the photo gallery against the finalized entries envelope (P4.6j unit 3)

_Versions: SPA 0.5.6._
...
#### `3d70fddc` — 2026-07-11 — Wire the delete + cascade-preview entry point from the edit view (P4.6j unit 2)

_Versions: SPA 0.5.5._
...
#### `eab23c0b` — 2026-07-11 — Port character cascade-delete preview + executor (P4.6i)

_Versions: core 0.0.172, harness 0.0.157._
...
#### `c7052b5b` — 2026-07-11 — Port the character photo gallery save-by-id (linkId) JSON leg (P4.6i)

_Versions: core 0.0.171, harness 0.0.156._
...
#### `eb6c9aa8` — 2026-07-11 — Port the character photo gallery list + remove JSON legs (P4.6i)

_Versions: core 0.0.170, harness 0.0.155._
...
#### `4e4d9583` — 2026-07-11 — Port the SillyTavern character-card JSON import/export legs (P4.6i)

_Versions: core 0.0.169, harness 0.0.154._
...
#### `b9a84c2e` — 2026-07-11 — Port the characters ?action=chats enriched recent-chats DTO (P4.6i)

_Versions: core 0.0.168, harness 0.0.153._
...
#### `fc1be046` — 2026-07-11 — Add the four porting-round workflow commands
...
#### `c28889c3` — 2026-07-11 — Dogfood finding #4: whole-card click on the characters roster

_Versions: SPA 0.5.3._
...
#### `6c7903ca` — 2026-07-10 — Unify P4.6f slice 4; restore the two annotated characters e2e beats

_Versions: SPA 0.5.2._
...
#### `edaa6490` — 2026-07-10 — P4.6f: the stats read action

_Versions: core 0.0.167, harness 0.0.152._
...
#### `2e696282` — 2026-07-10 — P4.6f: depiction-guidelines GET/PUT actions

_Versions: core 0.0.166, harness 0.0.151._
...
#### `790ad60b` — 2026-07-10 — P4.6f slice 4d: tags CRUD + the delete fan-out

_Versions: core 0.0.165, harness 0.0.150._
...
#### `b497bfab` — 2026-07-10 — P4.6f slice 4c: wardrobe mutations

_Versions: core 0.0.164, harness 0.0.149._
...
#### `b8e5a0db` — 2026-07-10 — P4.6f slice 4a: characters create / quick-create / update

_Versions: core 0.0.163, harness 0.0.148._
...
#### `22429017` — 2026-07-10 — P4.6f order: status header (slices 1-3 landed, slice 4 open)
...
#### `b29f2bbb` — 2026-07-10 — Unify the P4.6f/g/h + P4.4u3 round; wire and prove the characters e2e
...
#### `5d9aa5ef` — 2026-07-10 — P4.6f slice 3: the sub-resource mutations (dispatch + differential)

_Versions: core 0.0.161, harness 0.0.146._
...
#### `c0dc50bf` — 2026-07-10 — P4.6f slice 2: the characters action verbs (dispatch + differential)

_Versions: core 0.0.160, harness 0.0.145._
...
#### `e2d0aba4` — 2026-07-10 — P4.4u3: built-in seeds — roleplay templates + the three mount stores

_Versions: core 0.0.162, harness 0.0.147, host 0.0.10, web 0.0.7._
...
#### `f5addf1d` — 2026-07-10 — P4.6g: Characters SPA — detail/view, edit, and create screens

_Versions: SPA 0.5.0._
...
#### `d04b6dc5` — 2026-07-10 — Split the CLAUDE.md status journal into status-log.md
...
#### `c5e2a89f` — 2026-07-10 — Next-round work orders: Characters vertical, Salon virtualization, seeds
...
#### `ed417cd9` — 2026-07-10 — Dogfood fix: the Salon scroll chain (finding #3a)

_Versions: SPA 0.3.2._
...
#### `3a2c633d` — 2026-07-10 — Dogfood findings log: #1/#2 fixed, #3 (virtualization) promoted
...
#### `bb716528` — 2026-07-10 — Dogfood fix: tolerate never-migrated columns on real instances

_Versions: core 0.0.158._
...
#### `bcaa744c` — 2026-07-10 — Dogfood fix: isSilentMessage reads on migration-shaped instances

_Versions: core 0.0.157._
...
#### `0549b100` — 2026-07-10 — P4.6 unification: the c/d/e round integrated + both wires live

_Versions: core 0.0.156, host 0.0.9, web 0.0.6, SPA 0.3.1._
...
#### `3404a0ba` — 2026-07-10 — P4.6c: the Salon consolidation lane (skip / swipe-generate / chat-PUT / attachments + SPA controls)

_Versions: core 0.0.155, harness 0.0.143, host 0.0.8, SPA 0.2.2._
...
#### `4758d90d` — 2026-07-10 — P4.6d: the Settings server surface (dispatch backfill)
...
#### `83f34aa9` — 2026-07-10 — P4.6e: the Settings SPA vertical (Providers + wizard + Appearance)

_Versions: SPA 0.3.0._
...
#### `0cbaddfb` — 2026-07-10 — P4.6c + Settings work orders: the three-lane consolidation/Settings round
...
#### `1301f423` — 2026-07-10 — P4.6 unification: the first Salon vertical integrated on main (M4 live)

_Versions: SPA 0.2.1._
...
#### `94b45eb1` — 2026-07-10 — P4.6b: the Salon SPA vertical (list → open → read → send)

_Versions: SPA 0.2.0._
...
#### `64422d70` — 2026-07-10 — P4.6a: the Salon server read surface (enrichment + salon dispatch) + mutation handlers

_Versions: core 0.0.154, harness 0.0.141, host 0.0.7, web 0.0.5._
...
#### `dce222bf` — 2026-07-10 — P4.6 work orders: the first Salon vertical (M4), two parallel lanes
...
#### `40f5e080` — 2026-07-10 — Participants-null-seam unification: integrated on main (pure fast-forward)
...
#### `c3d9b5bb` — 2026-07-10 — Fix chats.participants explicit-null marshaling seam

_Versions: core 0.0.153, harness 0.0.140._
...
#### `b99a592b` — 2026-07-10 — P4.4u2b unification: the chat-creation spine integrated on main
...
#### `d4fa8191` — 2026-07-09 — P4.4u2b work order: the handleCreate spine + ChatCreate dispatch
...
#### `aed5a157` — 2026-07-09 — P4.4u2 unification: leaf sub-units 1-7 verified + integrated
...
#### `bc5b7430` — 2026-07-09 — P4.4 unit-2 sub-unit 6: chat continuation

_Versions: core 0.0.150._
...
#### `5d4f363f` — 2026-07-09 — P4.4 unit-2 sub-unit 5: the initial-greeting core

_Versions: core 0.0.149, harness 0.0.138._
...
#### `2187f18b` — 2026-07-09 — P4.4 unit-2 sub-unit 4: outfit selections

_Versions: core 0.0.148._
...
#### `2325ab2d` — 2026-07-09 — P4.4 unit-2 sub-unit 3: the identity-stack compiler write side

_Versions: core 0.0.147, harness 0.0.137._
...
#### `716e5cda` — 2026-07-09 — P4.4 unit-2 sub-unit 2: buildChatContext

_Versions: core 0.0.146, harness 0.0.136._
...
#### `8dbd0c58` — 2026-07-09 — P4.4 unit-2 sub-unit 7: the Green Room creation-progress bus (D6)

_Versions: core 0.0.145._
...
#### `656cf05e` — 2026-07-09 — P4.4 unit-2 sub-unit 1: the preset-scenario resolvers

_Versions: core 0.0.144, harness 0.0.135._
...
#### `2409c9c6` — 2026-07-09 — P4.4 unit-2 work order: chat creation + the Green Room
...
#### `885b3875` — 2026-07-09 — P4.4/P4.5 unification: contract cross-check + live setup e2e + status

_Versions: SPA 0.1.1._
...
#### `f2a41170` — 2026-07-09 — P4.4 unit 1: unlock/pepper-vault service + fresh-instance provisioning

_Versions: core 0.0.143, harness 0.0.134, web 0.0.3._
...
#### `65947dd8` — 2026-07-09 — P4.5: the Angular SPA foundation (apps/web)

_Versions: SPA 0.1.0._
...
#### `a101a0da` — 2026-07-09 — P4.4/P4.5 round kickoff: the two lane work orders
...
#### `bdb45f2f` — 2026-07-09 — P4.d unification: both drift re-port lanes integrated; folds + gate + 13-differential sweep green
...
#### `dc083967` — 2026-07-09 — P4.d2: "nothing to add" turn-skipping (v4 b90cd1f5) ported across the spine

_Versions: host 0.0.5, web 0.0.2._
...
#### `fbd91532` — 2026-07-09 — P4.d re-port round: the two lane work orders
...
#### `34c2fd67` — 2026-07-09 — Drift check v4 2494a84b..a7b1398d: three spine differentials stale; mirror refreshed
...
#### `2d59dfec` — 2026-07-08 — P4.2/P4.3 unification: both transport lanes integrated; gate + CLI differential green
...
#### `41aa51f2` — 2026-07-08 — P4.2: quilltap-web — the axum HTTP transport + the M2 chat-send smoke

_Versions: web 0.0.1._
...
#### `cb051d6a` — 2026-07-08 — P4.3 Tier R: the native quilltap CLI, byte-diffed against the v4 launcher

_Versions: cli 0.0.1._
...
#### `b72c1b4b` — 2026-07-08 — P4.2/P4.3 round kickoff: drift check + the two lane work orders
...
#### `f857c818` — 2026-07-08 — P4.1 unification: all four host-driver lanes integrated; gates + 12-differential sweep green
...
#### `c6421edb` — 2026-07-08 — P4.1a: provider-IO host drivers — streaming composer, reqwest wire, live pricing fetch, API-path embedding provider

_Versions: core 0.0.139, harness 0.0.132, host 0.0.2._
...
#### `f08c070c` — 2026-07-08 — P4.1c: PTY/terminal host driver + the Ariel announcement writers
...
#### `ec1542da` — 2026-07-08 — P4.1d: environment/cadence lane — instance lock, scheduler sweeps, danger scan, SelfInventoryEnv
...
#### `e03193dd` — 2026-07-08 — P4.1b: file/image host drivers — the byte layer is real
...
#### `089b99f5` — 2026-07-08 — P4.1 kickoff: drift check (no drift at 2494a84b) + the four host-driver lane work orders
...
#### `19fca4e1` — 2026-07-08 — P4.0: Core API boundary + quilltap-host composition root (milestone M0)

_Versions: core 0.0.138, host 0.0.1._
...
#### `96b7249a` — 2026-07-08 — Phase-4 kickoff: phase-4.md with 22 locked decisions; drift check to 2494a84b
...
#### `4606fda5` — 2026-07-08 — U4.4: enclave step() + schedule tick + runner rows — Phase 3 complete

_Versions: core 0.0.137, harness 0.0.131._
...
#### `693dcc80` — 2026-07-08 — U4.1–U4.3: enclave milestones + cron + announce/lifecycle, each differential-green

_Versions: core 0.0.136, harness 0.0.130._
...
#### `3f53ee76` — 2026-07-08 — Drift check: v4 6b6e39ad..6bf88959 audited — no ported unit stale; new baseline 6bf88959
...
#### `8d2de73c` — 2026-07-08 — Docs + reconciliation: unify the cleanup round (W4.11a, W4.11b, W4.11c)
...
#### `d804ca1a` — 2026-07-08 — W4.11a: Arc provider impls + spine with_logging/llm_logs dump + ask_carina seam wiring
...
#### `d2a8baa6` — 2026-07-08 — Docs: write the W4.11a/b/c cleanup-round work orders; lay out the pre-enclave round
...
#### `35907870` — 2026-07-08 — Docs + reconciliation: unify the wiring round (W4.10a, W4.5b, W4.10b)

_Versions: core 0.0.134, harness 0.0.128._
...
#### `6d084ddf` — 2026-07-08 — W4.10a: CHANGELOG, versions, CLAUDE.md status

_Versions: core 0.0.132, harness 0.0.122._
...
#### `e49a849b` — 2026-07-08 — Docs: write the wiring-round work orders (W4.10a, W4.5b, W4.10b)
...
#### `2945e956` — 2026-07-08 — W4.10b step 5: regenerate avatar + story-background job differentials with logLLMCall live

_Versions: harness 0.0.126._
...
#### `34efc3ca` — 2026-07-08 — W4.10b step 4: regenerate image_generation_tier3 with logLLMCall live

_Versions: core 0.0.133, harness 0.0.125._
...
#### `e2cd302b` — 2026-07-08 — W4.10b step 3: regenerate answer_confirmation_tier3 with logLLMCall live

_Versions: harness 0.0.124._
...
#### `348371a6` — 2026-07-08 — W4.10b step 2: regenerate danger_gatekeeper_tier3 with logLLMCall live

_Versions: harness 0.0.123._
...
#### `7539438b` — 2026-07-08 — W4.5b: port the Brahma one-shot console (runBrahmaQuery)
...
#### `68a039d9` — 2026-07-08 — Docs: record the Round-4-remainder unification (W4.4b, W4.5, W4.7e2, W4.7e3)
...
#### `722ca02b` — 2026-07-07 — W4.7e2: port the BUILTIN TF-IDF/BM25 embedding provider
...
#### `8f12299a` — 2026-07-07 — W4.7e3: wire the six logLLMCall call-site closures
...
#### `5d10752d` — 2026-07-07 — W4.5: port the Carina query engine + async RunCarinaQuery seam
...
#### `788313eb` — 2026-07-07 — W4.4b: port the chat file/attachment LLM-load subsystem; close both spine seams

_Versions: core 0.0.131, harness 0.0.121._
...
#### `e73145c5` — 2026-07-07 — Docs: write the W4.7e2 + W4.7e3 work orders; lay out the Round-4 remainder
...
#### `62e818f6` — 2026-07-07 — Round-4 unification: adapt W4.9c to the W4.7f GeneratedImageData widening

_Versions: core 0.0.130, harness 0.0.120._
...
#### `dec8cc8a` — 2026-07-07 — Wire the remaining Librarian doc-edit announcements (W4.6c)
...
#### `65a36695` — 2026-07-07 — W4.9c: port the avatar + story-background job handlers
...
#### `04d76cd7` — 2026-07-07 — W4.7e: pricing, capability, logging, embeddings (sub-units 1-4)
...
#### `5216420d` — 2026-07-07 — W4.7d: transport, LLM error taxonomy, api_keys (the last unported repo)
...
#### `580fbdeb` — 2026-07-07 — W4.7f: image wire dialects + OpenAI moderation + Serper web search

_Versions: core 0.0.129, harness 0.0.119._
...
#### `5635e2e8` — 2026-07-07 — Docs: write the five remaining Round-4/follow-up work orders (W4.6c, W4.7d/e/f, W4.9c)
...
#### `df6398b5` — 2026-07-07 — Wire the Librarian doc-save change:{diff} announcement (Round-3 Group 6)

_Versions: core 0.0.128, harness 0.0.118._
...
#### `a85f91a5` — 2026-07-07 — Make the context-summary vault-mirror + refresh seams live (Round-3 Group 7)

_Versions: core 0.0.127, harness 0.0.117._
...
#### `40219f73` — 2026-07-07 — Thread the resolved cheap-LLM selection into the spine (Round-3 Group 8)

_Versions: core 0.0.126, harness 0.0.116._
...
#### `33c18372` — 2026-07-07 — Dedup build_context commonplace builders against the canonical module (Round-3 Group 5)

_Versions: core 0.0.125._
...
#### `4d50630d` — 2026-07-07 — Rewire the Lantern sink to the canonical byte-exact writer (Round-3 Group 4)

_Versions: core 0.0.124, harness 0.0.115._
...
#### `baef33bf` — 2026-07-07 — Wire the end-of-turn wardrobe announcement drain into the spine (Round-3 Group 3)

_Versions: core 0.0.123._
...
#### `3a59411a` — 2026-07-07 — Wire W4.6b post-office whisper writers into the spine (Round-3 Group 2)

_Versions: core 0.0.122, harness 0.0.114._
...
#### `0d6d6243` — 2026-07-07 — Wire W4.7c tool reshape/detector/strategy into the spine (Round-3 Group 1)

_Versions: core 0.0.121, harness 0.0.113._
...
#### `00561d9b` — 2026-07-07 — Port the Courier transport + compression-cache spine plumbing (W4.4a4)
...
#### `3459a091` — 2026-07-07 — Port the post-office / personified whisper writers (Phase-3 W4.6b)
...
#### `479a3c43` — 2026-07-07 — Port the provider request builders + the four RequestTransform hooks (W4.7c part 2)

_Versions: core 0.0.120, harness 0.0.112, fixture-sanitizer 0.0.3._
...
#### `a4f0db83` — 2026-07-07 — Port the provider tool-wire — formatTools/parseToolCalls/text-markers (W4.7c part 1)

_Versions: core 0.0.119, harness 0.0.111, fixture-sanitizer 0.0.2._
...
#### `fd35eebf` — 2026-07-07 — Drift check: retrofit v4 6b6e39ad (image-description reuse + avatar crop)
...
#### `1dfb87b4` — 2026-07-06 — Port the answer-confirmation service (W4.3)

_Versions: core 0.0.118, harness 0.0.110._
...
#### `4207ce2a` — 2026-07-06 — Port the image-generation subsystem — generate_image (W4.9a)
...
#### `7fe3a70a` — 2026-07-06 — Port the buildContext feeder closures (Phase-3 W4.6a)
...
#### `f7bbab5f` — 2026-07-06 — Integrate the five parallel wave-4 units (W4.7a/W4.7b/W4.2u/W4.8/W4.9b)
...
#### `c241230a` — 2026-07-06 — Port the provider manifest + registry core (Phase 3, wave 4 / W4.7a)

_Versions: core 0.0.117, harness 0.0.109._
...
#### `98d3091a` — 2026-07-06 — Port the background job runner (Phase-3 W4.8, v4 8617ce7a)
...
#### `e54765e7` — 2026-07-06 — Re-port the unified diff as a Myers line diff (drift W4.d1, v4 8617ce7a)

_Versions: core 0.0.116, harness 0.0.108._
...
#### `bbce1800` — 2026-07-06 — Plan the Phase-3 endgame: work orders for every remaining unit + a drift check
...
#### `37a7e3c5` — 2026-07-05 — Port the compression cache service (W4.4a part 3)

_Versions: core 0.0.114, harness 0.0.106._
...
#### `5c94eb3f` — 2026-07-05 — Port regenerate-swipe as an orchestrator-family entry point (W4.4a part 2)

_Versions: core 0.0.113, harness 0.0.105._
...
#### `acdf8c6c` — 2026-07-05 — Port the agent-mode resolver + close the orchestrator seam (W4.4a part 1)

_Versions: core 0.0.112, harness 0.0.104._
...
#### `cd58193d` — 2026-07-01 — Catch up 6 marshaling surfaces to v4's answer-confirmation columns

_Versions: core 0.0.81, harness 0.0.74._
...
#### `162b10a0` — 2026-07-01 — Start Phase 3: the writer-task runtime and model boundary (Units 0 + 0.5)

_Versions: core 0.0.77._
...
#### `c4184e97` — 2026-07-01 — Port the memory gate (Phase 3 Unit 1): first tier-3 → tier-2 service

_Versions: core 0.0.78, harness 0.0.71._
...
#### `fa5c10e0` — 2026-07-01 — Port the memory deletion chokepoint (Phase 3, first memory-family follow-on)

_Versions: core 0.0.79, harness 0.0.72._
...
#### `1cf8dc3b` — 2026-07-01 — Port the memory-service cascade-delete family (Phase 3 memory follow-on)

_Versions: core 0.0.82, harness 0.0.75._
...
#### `f90312a8` — 2026-07-01 — Port memory housekeeping (Phase 3 memory follow-on)

_Versions: core 0.0.83, harness 0.0.76._
...
#### `c2cf5ebf` — 2026-07-02 — Port the completion half of the model boundary (Phase 3)

_Versions: core 0.0.84._
...
#### `d389483c` — 2026-07-02 — Port the memory-extraction pure leaves (Phase 3, memory-processor tier-1 half)

_Versions: core 0.0.85, harness 0.0.77._
...
#### `1084b037` — 2026-07-02 — Port the memory processor (Phase 3, tier-3 — both model boundaries pinned)

_Versions: core 0.0.86, harness 0.0.78._
...
#### `cd764039` — 2026-07-02 — Port the memory gate's watermark auto-housekeeping check (Phase 3)

_Versions: core 0.0.87, harness 0.0.79._
...
#### `94fb1942` — 2026-07-02 — Start chat orchestration (Phase 3 Unit 3): decomposition + waves 1-2

_Versions: core 0.0.88, harness 0.0.80._
...
#### `6d44ec53` — 2026-07-02 — Port chat orchestration wave 3 batch 1 (Phase 3): seven services in parallel

_Versions: core 0.0.89, harness 0.0.81._
...
#### `696e63f9` — 2026-07-02 — Port chat orchestration wave 3 batch 2 (Phase 3): finalizer + buildContext

_Versions: core 0.0.90, harness 0.0.82._
...
#### `94bb844a` — 2026-07-02 — Port the chat-orchestration capstone (Phase 3): processMessage + executeTurnChain

_Versions: core 0.0.91, harness 0.0.83._
...
#### `0b04fd0c` — 2026-07-03 — Drift check: audit v4 8efe1ba9..f69200bb against the ported surface
...
#### `4024c787` — 2026-07-03 — Port buildMessageContext + resolve the chain-depth divergence (Phase 3)

_Versions: core 0.0.92, harness 0.0.84._
...
#### `c00d9dc7` — 2026-07-05 — Port the dangerous-content orchestration subsystem (Phase 3, wave 4 / W4.2)

_Versions: core 0.0.115, harness 0.0.107._
...
#### `af2c9fb4` — 2026-07-04 — Port buildTools + wire the tool-slate spine (Phase 3, wave 4 / W4.1g — closes W4.1)

_Versions: core 0.0.111, harness 0.0.103._
...
#### `9bc4d580` — 2026-07-04 — Complete the doc-edit tool handlers + wire the dispatcher (Phase 3, wave 4 / W4.1d3b part 2)

_Versions: core 0.0.105, harness 0.0.97._
...
#### `bec5b867` — 2026-07-04 — Port the doc-edit foundation + text/markdown handlers (Phase 3, wave 4 / W4.1d3b part 1)

_Versions: core 0.0.104, harness 0.0.96._
...
#### `9393a883` — 2026-07-04 — Port the text-tool loop + wire the orchestrator passes (Phase 3, wave 4 / W4.1f)

_Versions: core 0.0.103, harness 0.0.95._
...
#### `846fafdc` — 2026-07-04 — Port the search/introspection tool handlers (Phase 3, wave 4 / W4.1d batch 4)

_Versions: core 0.0.106, harness 0.0.98._
...
#### `285b674b` — 2026-07-05 — Port the generate_image pure leaves (Phase 3, wave 4 / W4.1d5 part 4)

_Versions: core 0.0.110, harness 0.0.102._
...
#### `7d2707c3` — 2026-07-04 — Port the search_web tool handler (Phase 3, wave 4 / W4.1d5 part 3)

_Versions: core 0.0.109, harness 0.0.101._
...
#### `fff009fe` — 2026-07-04 — Port the Post Office + ask_carina tool handlers (Phase 3, wave 4 / W4.1d5 part 2)

_Versions: core 0.0.108, harness 0.0.100._
...
#### `3a72e565` — 2026-07-04 — Port the state + run_sql tool handlers (Phase 3, wave 4 / W4.1d5 part 1)

_Versions: core 0.0.107, harness 0.0.99._
...
#### `8aeb7302` — 2026-07-04 — Port the doc-edit path resolver + URI producers (Phase 3, wave 4 / W4.1d batch 3a, part 3)

_Versions: core 0.0.102, harness 0.0.94._
...
#### `33513fc2` — 2026-07-04 — Port the doc-edit pure leaves (Phase 3, wave 4 / W4.1d batch 3a, part 2)

_Versions: core 0.0.101, harness 0.0.93._
...
#### `b0149d6e` — 2026-07-04 — Port the tiered mount pool + the qtap:// URI codec (Phase 3, wave 4 / W4.1d batch 3a, part 1)

_Versions: core 0.0.100, harness 0.0.92._
...
#### `feb7e694` — 2026-07-04 — Port the native tool loop + close the finalizer response-RNG (Phase 3, wave 4 / W4.1e)

_Versions: core 0.0.98, harness 0.0.90._
...
#### `ad9a7aec` — 2026-07-04 — Port the first tool-handler batch + the dispatching runner (Phase 3, wave 4 / W4.1d batch 1)

_Versions: core 0.0.97, harness 0.0.89._
...
#### `a9d6b5cb` — 2026-07-04 — Port the wardrobe tool handlers (Phase 3, wave 4 / W4.1d batch 2)

_Versions: core 0.0.99, harness 0.0.91._
...
#### `168e19f6` — 2026-07-03 — Port tool execution + persistence primitives (Phase 3, wave 4 / W4.1c)

_Versions: core 0.0.96, harness 0.0.88._
...
#### `0d49a877` — 2026-07-03 — Port the tool-subsystem pure leaves (Phase 3, wave 4 / W4.1b)

_Versions: core 0.0.95, harness 0.0.87._
...
#### `3d95f333` — 2026-07-03 — Port the RNG subsystem (Phase 3, wave 4 / W4.1a)

_Versions: core 0.0.94, harness 0.0.86._
...
#### `79a8204b` — 2026-07-03 — Port the wardrobe drift batch (Phase 3, wave 4 / W4.0)

_Versions: core 0.0.93, harness 0.0.85._
...
#### `adbac977` — 2026-07-01 — Mark Phase 2 complete in the docs and draft the Phase 3 kickoff
...
#### `eed152b8` — 2026-07-01 — Add the real-snapshot fixture sanitizer (Phase-2 Deliverable B)

_Versions: fixture-sanitizer 0.0.1._
...
#### `8278f43a` — 2026-07-01 — Port the characters startup-backfill family (closes the last 3 characters seams)

_Versions: core 0.0.76, harness 0.0.70._
...
#### `3888d846` — 2026-07-01 — Close the isSilentMessage write side (completes seam #8)

_Versions: core 0.0.75, harness 0.0.69._
